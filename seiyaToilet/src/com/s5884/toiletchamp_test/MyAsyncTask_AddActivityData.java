...
public class MyAsyncTask_AddActivityData extends AsyncTask<ActivityData_Add, Void, Void> implements Serializable {
	...
	//constructor
	public MyAsyncTask_AddActivityData(TextView _textView) {
		super();
		this.textView = _textView;		
	}
	
	@Override
	protected Void doInBackground(ActivityData_Add... _data) {
